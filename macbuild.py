...
INCLUDE_DIR="-I ./include/ -I/Library/Frameworks/SDL2.framework/Headers -I ./include/ -I/Library/Frameworks/SDL2_image.framework/Headers -I ./include/ -I/Library/Frameworks/SDL2_ttf.framework/Headers -I ./include/ -I/Library/Frameworks/SDL2_mixer.framework/Headers"

# What libraries do we want to include
LIBRARIES="-F/Library/Frameworks -framework SDL2 -F/Library/Frameworks -framework SDL2_ttf -F/Library/Frameworks -framework SDL2_mixer -F/Library/Frameworks -framework SDL2_image"
